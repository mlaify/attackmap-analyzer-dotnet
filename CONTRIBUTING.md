# Contributing to `attackmap-analyzer-dotnet`
...
```bash
git clone https://github.com/mlaify/attackmap-analyzer-dotnet.git
cd attackmap-analyzer-dotnet
python -m venv .venv
...
Open a [bug report](https://github.com/mlaify/attackmap-analyzer-dotnet/issues/new?template=bug_report.md).
...
Open a [feature request](https://github.com/mlaify/attackmap-analyzer-dotnet/issues/new?template=feature_request.md).
...
By contributing to `attackmap-analyzer-dotnet`, you agree that your contributions will be
